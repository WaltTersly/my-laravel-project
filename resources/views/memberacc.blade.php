    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
         ...
         <img src="/img/avatar/{{Auth::user()->avatar}}" class="img-circle elevation-2" alt="profile Pic" style="width:32px; height:32px; float:left; border-radius:50px; margin-right:25px;">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="{{ url()->previous() }}" class="nav-link active">
          ...
          <li class="nav-item">
                <a href="{{ url('/memberprofile') }}" class="nav-link active">
