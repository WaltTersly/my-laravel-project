...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/AdminLTELogo.png" alt="GYMMS Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <tbody>
            ...
            <tr>
                <form action="{{ route('admin.assign') }}" method="post">
                    ...
                    <td><input type="checkbox" {{ $user->hasRole('trainer') ? 'checked' : ''}} name="role_trainer"></td>
                    <td><input type="checkbox" {{ $user->hasRole('cashier') ? 'checked' : ''}} name="role_cashier"></td>
