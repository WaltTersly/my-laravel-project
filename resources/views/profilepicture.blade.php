    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
         ...
         <img src="/img/avatar/{{Auth::user()->avatar}}" class="img-circle elevation-2" alt="profile Pic" style="width:52px; height:52px; float:left; border-radius:50px; margin-right:25px;">
        </div>
        <div class="info">
         <h2><a href="#" class="d-block" role="button">{{ Auth::user()->name }}<span class="caret"></span></a></h2>
        </div>
      </div>
  ...
  <!-- /.content-wrapper -->
   ...
   <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="{{ url('/memberacc') }}" title="Back"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button></a>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <div class="row justify-content-center">
                     ...
                     <img src="/img/avatar/{{Auth::user()->avatar}}" class="img-circle elevation-2" alt="profile Pic" style="width:250px; height:250px; float:left; border-radius:50px; margin-right:25px;">
                     
                </div> 

                 <br>
                      <input type="file" class="form-control " name="avatar" required autofocus>
