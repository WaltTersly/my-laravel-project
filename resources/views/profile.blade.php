        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              ...
              <h3 class="profile-username text-center">{{$user->trainer->First_name}}</h3>
              
                <p class="text-muted text-center"><i>Trainer</i></p>

                <ul class="list-group list-group-unbordered mb-3">
                   <li class="list-group-item">
                    <b>First name</b> <a class="float-right">{{$user->trainer->First_name}}</a>
                  </li>
                   <li class="list-group-item">
                    <b>surname</b> <a class="float-right">{{$user->trainer->surname}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Gender</b> <a class="float-right">{{$user->trainer->Gender}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Address</b> <a class="float-right">{{$user->trainer->Address}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Telephone</b> <a class="float-right">{{$user->trainer->Telephone}}</a>
                  </li>
                </ul>
